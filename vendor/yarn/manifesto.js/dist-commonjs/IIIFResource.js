...
var IIIFResource = /** @class */ (function (_super) {
    ...
    IIIFResource.prototype.getAttribution = function () {
        ...
        if (attribution) {
            return internal_1.LanguageMap.parse(attribution, this.options.locale);
        }
        return [];
    };
    IIIFResource.prototype.getDescription = function () {
        ...
        if (description) {
            return internal_1.LanguageMap.parse(description, this.options.locale);
        }
        return [];
    };
        ...
        return new Promise(function (resolve) {
            if (that.isLoaded) {
                ...
                internal_1.Utils.loadManifest(id).then(function (data) {
                    that.parentLabel = (internal_1.LanguageMap.getValue(that.getLabel(), options_1.locale));
