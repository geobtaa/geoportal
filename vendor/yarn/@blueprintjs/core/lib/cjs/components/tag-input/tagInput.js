...
var TagInput = /** @class */ (function (_super) {
    ...
    TagInput.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classes, onBlur: this.handleContainerBlur, onClick: this.handleContainerClick },
            ...
            React.createElement("div", { className: common_1.Classes.TAG_INPUT_VALUES },
                ...
                this.props.children,
                React.createElement("input", tslib_1.__assign({ value: this.state.inputValue }, inputProps, { onFocus: this.handleInputFocus, onChange: this.handleInputChange, onKeyDown: this.handleInputKeyDown, onKeyUp: this.handleInputKeyUp, onPaste: this.handleInputPaste, placeholder: resolvedPlaceholder, ref: this.refHandlers.input, className: classnames_1.default(common_1.Classes.INPUT_GHOST, inputProps === null || inputProps === void 0 ? void 0 : inputProps.className), disabled: disabled }))),
    ...
    TagInput.prototype.removeIndexFromValues = function (index) {
        var _a, _b;
        var _c = this.props, onChange = _c.onChange, onRemove = _c.onRemove, values = _c.values;
        onRemove === null || onRemove === void 0 ? void 0 : onRemove((_b = (_a = values[index]) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : "", index, values[index]);
        if (common_1.Utils.isFunction(onChange)) {
