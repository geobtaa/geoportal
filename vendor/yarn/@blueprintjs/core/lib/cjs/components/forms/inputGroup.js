...
var InputGroup = /** @class */ (function (_super) {
    ...
    InputGroup.prototype.render = function () {
        var _a;
        var _b = this.props, className = _b.className, disabled = _b.disabled, fill = _b.fill, inputRef = _b.inputRef, intent = _b.intent, large = _b.large, small = _b.small, round = _b.round;
        ...
        return (React.createElement("div", { className: classes },
            ...
            React.createElement(asyncControllableInput_1.AsyncControllableInput, tslib_1.__assign({ type: "text" }, props_1.removeNonHTMLProps(this.props), { className: common_1.Classes.INPUT, inputRef: inputRef, style: style })),
