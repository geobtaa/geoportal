...
let InputGroup = class InputGroup extends AbstractPureComponent2 {
    ...
    render() {
        ...
        return (React.createElement("div", { className: classes },
            ...
            React.createElement(AsyncControllableInput, Object.assign({ type: "text" }, removeNonHTMLProps(this.props), { className: Classes.INPUT, inputRef: inputRef, style: style })),
