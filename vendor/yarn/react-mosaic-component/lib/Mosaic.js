...
var HTML5toTouch_1 = __importDefault(require("react-dnd-multi-backend/lib/HTML5toTouch"));
...
var Mosaic = /** @class */ (function (_super) {
    ...
    Mosaic = __decorate([
        react_dnd_1.DragDropContext(react_dnd_multi_backend_1.default(HTML5toTouch_1.default))
    ], Mosaic);
    return Mosaic;
