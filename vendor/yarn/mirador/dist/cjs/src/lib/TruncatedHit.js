...
var TruncatedHit = /*#__PURE__*/function () {
  ...
  function TruncatedHit(hit) {
    var maxChars = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 200;
    var minimum = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 20;
  ...
  _createClass(TruncatedHit, [{
    key: "charsOnSide",
    get: function get() {
      var resultingChars = (this.maxChars - this.hit.match.length) / 2;
