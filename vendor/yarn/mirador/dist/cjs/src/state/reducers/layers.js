...
var layersReducer = function layersReducer() {
  ...
  switch (action.type) {
    case _actionTypes["default"].UPDATE_LAYERS:
      return _objectSpread({}, state, _defineProperty({}, action.windowId, _objectSpread({}, state[action.windowId], _defineProperty({}, action.canvasId, (0, _deepmerge["default"])((state[action.windowId] || {})[action.canvasId] || {}, action.payload)))));

    case _actionTypes["default"].REMOVE_WINDOW:
      return (0, _immutable.removeIn)(state, [action.windowId]);
