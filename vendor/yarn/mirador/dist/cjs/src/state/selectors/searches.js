...
var getSelectedContentSearchAnnotationIds = (0, _reselect.createSelector)([_windows.getWindow, getSearchForCompanionWindow], function (window, search) {
  return search && search.selectedContentSearchAnnotation || window && window.selectedContentSearchAnnotation || [];
});
exports.getSelectedContentSearchAnnotationIds = getSelectedContentSearchAnnotationIds;
var getSelectedContentSearchAnnotations = (0, _reselect.createSelector)([getSearchAnnotationsForWindow, getSelectedContentSearchAnnotationIds], function (searchAnnotations, selectedAnnotationIds) {
  return searchAnnotations.map(function (annotation) {
    return {
...
exports.getSelectedContentSearchAnnotations = getSelectedContentSearchAnnotations;
