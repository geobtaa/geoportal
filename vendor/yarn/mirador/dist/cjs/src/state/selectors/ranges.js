...
var getVisibleLeafAndBranchNodeIds = (0, _reselect.createSelector)([_manifests.getManifestTreeStructure, _canvases.getVisibleCanvases], function (tree, canvases) {
  if (!canvases) {
    return [];
  }
...
var getDefaultSidebarVariant = (0, _reselect.createSelector)([_manifests.getManifestTreeStructure], function (tree) {
