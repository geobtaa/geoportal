...
export var layersReducer = function layersReducer() {
  ...
  switch (action.type) {
    case ActionTypes.UPDATE_LAYERS:
      return _objectSpread({}, state, _defineProperty({}, action.windowId, _objectSpread({}, state[action.windowId], _defineProperty({}, action.canvasId, deepmerge((state[action.windowId] || {})[action.canvasId] || {}, action.payload)))));
