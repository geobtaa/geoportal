...
export var manifestsReducer = function manifestsReducer() {
  ...
  switch (action.type) {
    case ActionTypes.REQUEST_MANIFEST:
      return _objectSpread(_defineProperty({}, action.manifestId, _objectSpread({}, state[action.manifestId], {}, action.properties, {
        id: action.manifestId
      })), omit(state, action.manifestId));

    case ActionTypes.RECEIVE_MANIFEST:
      return _objectSpread({}, state, _defineProperty({}, action.manifestId, _objectSpread({}, state[action.manifestId], {
        error: null,
