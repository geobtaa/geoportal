...
export var errorsReducer = function errorsReducer() {
  ...
  switch (action.type) {
    case ActionTypes.ADD_ERROR:
      return _objectSpread({}, state, (_objectSpread2 = {}, _defineProperty(_objectSpread2, action.id, {
        id: action.id,
    ...
    case ActionTypes.RECEIVE_INFO_RESPONSE_FAILURE:
      return _objectSpread({}, state, (_objectSpread3 = {}, _defineProperty(_objectSpread3, action.infoId, {
        id: action.infoId,
    ...
    case ActionTypes.RECEIVE_SEARCH_FAILURE:
      return _objectSpread({}, state, (_objectSpread4 = {}, _defineProperty(_objectSpread4, action.searchId, {
        id: action.searchId,
        message: action.error
