...
var getVisibleLeafAndBranchNodeIds = createSelector([getManifestTreeStructure, getVisibleCanvases], function (tree, canvases) {
  if (!canvases) {
    return [];
  }
...
export var getDefaultSidebarVariant = createSelector([getManifestTreeStructure], function (tree) {
