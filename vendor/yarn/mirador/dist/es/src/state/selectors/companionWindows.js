...
export var getThumbnailNavigationPosition = createSelector([getWindow, function (state) {
  return state.companionWindows;
...
var getCompanionWindowIndexByWindowAndPosition = createSelector([getWindows, getCompanionWindows], function (windows, companionWindows) {
  return (Object.keys(windows) || []).reduce(function (obj, id) {
    return _objectSpread({}, obj, _defineProperty({}, id, groupBy(windows[id].companionWindowIds, function (cwid) {
...
var getCompanionWindowsByWindowAndPosition = createSelector([getWindows, getCompanionWindows], function (windows, companionWindows) {
  return (Object.keys(windows) || []).reduce(function (obj, id) {
    return _objectSpread({}, obj, _defineProperty({}, id, groupBy(windows[id].companionWindowIds.map(function (cwid) {
...
export var getCompanionWindowIdsForPosition = createSelector([getCompanionWindowIdsOfWindow, function (state, _ref6) {
...
export var getCompanionAreaVisibility = createSelector([function (state, _ref8) {
