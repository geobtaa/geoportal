...
export var getSelectedContentSearchAnnotations = createSelector([getSearchAnnotationsForWindow, getSelectedContentSearchAnnotationIds], function (searchAnnotations, selectedAnnotationIds) {
