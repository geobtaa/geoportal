...
export var getCanvases = createSelector([getManifestoInstance], function (manifest) {
...
export var getCanvas = createSelector([getManifestoInstance, function (state, _ref) {
...
export var getCurrentCanvas = createSelector([getManifestoInstance, getWindow], function (manifest, window) {
...
export var getCanvasGrouping = createSelector([getCanvasGroupings, function (state, _ref3) {
...
export var getVisibleCanvasNonTiledResources = createSelector([getVisibleCanvases], function (canvases) {
  return flatten(canvases.map(function (canvas) {
    return new ManifestoCanvas(canvas).imageResources;
  })).filter(function (resource) {
    return resource.getServices().length < 1;
  });
});
export var selectInfoResponse = createSelector([getCanvas, selectInfoResponses], function (canvas, infoResponses) {
  if (!canvas) return undefined;
...
export function selectNextAuthService(_ref4, resource) {
  var auth = _ref4.auth;
...
export var selectCanvasAuthService = createSelector([selectInfoResponse, function (state) {
  return state;
...
export function selectAuthStatus(_ref5, service) {
  var auth = _ref5.auth;
...
function getServices(resource, profile) {
  var services = Utils.getServices(_objectSpread({}, resource, {
    options: {}
  }));
