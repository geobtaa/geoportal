...
import { getNextCanvasGrouping, getPreviousCanvasGrouping, getManifestCanvases, getCanvasIndex, getWindowViewType, getManifestViewingDirection } from '../state/selectors';
/**
...
var mapStateToProps = function mapStateToProps(state, _ref) {
  ...
  return {
    canvasGroupings: new CanvasGroupings(getManifestCanvases(state, {
      windowId: windowId
    }), viewType),
    ...
    view: viewType,
    viewingDirection: getManifestViewingDirection(state, {
      windowId: windowId
    })
  };
};
