...
import { getManifestTreeStructure, getVisibleNodeIds, getExpandedNodeIds, getNodeIdToScrollTo } from '../state/selectors';
...
var mapStateToProps = function mapStateToProps(state, _ref) {
  ...
  return {
    ...
    treeStructure: getManifestTreeStructure(state, {
      windowId: windowId
    }),
