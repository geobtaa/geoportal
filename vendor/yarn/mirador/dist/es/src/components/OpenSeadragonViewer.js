var _jsxFileName = "/Users/pjreed/dev/mirador/dist/es/src/components/OpenSeadragonViewer.js";
...
export var OpenSeadragonViewer = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OpenSeadragonViewer, [{
    ...
    value: function componentDidMount() {
      ...
      this.viewer = new OpenSeadragon(_objectSpread({
    ...
    value: function fitBounds(x, y, w, h) {
      ...
      this.viewer.viewport.fitBounds(new OpenSeadragon.Rect(x, y, w, h), immediately);
    }
    /**
