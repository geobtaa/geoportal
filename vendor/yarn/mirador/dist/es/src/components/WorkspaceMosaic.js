var _jsxFileName = "/Users/pjreed/dev/mirador/dist/es/src/components/WorkspaceMosaic.js";
...
export var WorkspaceMosaic = /*#__PURE__*/function (_React$Component) {
  ...
  function WorkspaceMosaic(props) {
    ...
    _this.zeroStateView = /*#__PURE__*/React.createElement("div", {
  ...
  _createClass(WorkspaceMosaic, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (!prevWindows.every(function (e) {
        ...
        var removedWindows = difference(prevWindows, currentWindows);
    ...
    value: function determineWorkspaceLayout() {
      ...
      var sortedWindows = toPairs(windows).sort(function (a, b) {
      ...
      if (!sortedWindows.every(function (e) {
        ...
        var addedWindows = difference(sortedWindows, leaveKeys);
        var newLayout = new MosaicLayout(layout);
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Mosaic, {
