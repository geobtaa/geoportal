...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.advanced_search[:form_solr_parameters]['facet.field'] ||= %W[schema_provider_s gbl_resourceType_sm]
    ...
    config.add_facet_field 'gbl_resourceType_sm', :label => 'Genre', :limit => 8, collapse: false
    ...
    config.add_show_field 'dct_accessRights_s', label: 'Access Rights'
    ...
    config.add_sort_field 'score desc, dct_title_s asc', :label => 'relevance'
    config.add_sort_field 'gbl_indexYear_im desc, dct_title_s asc', :label => 'year'
    config.add_sort_field 'dct_publisher_sort asc, dct_title_s asc', :label => 'publisher'
