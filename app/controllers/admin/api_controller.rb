...
module Admin
  class ApiController < ApplicationController
    ...
    configure_blacklight do |config|
      ...
      config.advanced_search[:form_solr_parameters]['facet.field'] ||= %W[schema_provider_s gbl_resourceClass_sm b1g_code_s dct_isPartOf_sm]
      ...
      # Type
      config.add_facet_field 'gbl_resourceClass_sm', label: 'Type', limit: 8
      # Contributor
      ...
      config.add_index_field 'gbl_indexYear_im'
      config.add_index_field 'dct_creator_sm'
      config.add_index_field 'dct_description_sm', helper_method: :snippit
      config.add_index_field 'dct_publisher_sm'
      ...
      config.add_show_field 'gbl_resourceClass_sm', label: 'Type', itemprop: 'keywords', link_to_facet: true
      ...
      config.add_sort_field 'gbl_indexYear_i desc, dct_title_sort asc', :label => 'year'
