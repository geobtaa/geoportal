...
RSpec.describe "geonames/new", type: :view do
  before(:each) do
    assign(:geoname, Geoname.new(
      :geonameid => "",
      :name => "MyString",
      :asciiname => "MyString",
  ...
  it "renders new geoname form" do
    render

    assert_select "form[action=?][method=?]", geonames_path, "post" do
